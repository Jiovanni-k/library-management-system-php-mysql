...
```bash
git clone https://github.com/Jiovanni-k/Library-Management-System-PHP-MySQL.git
...
**Developed by:** jiovanni-k

**Contact:**
- 💻 GitHub: [jiovanni-k](https://github.com/jiovanni-k)
